...
carro = input('qual foi o carro alugado?: ')
...
diaria = valor_dia * dias_alugados
valor_adicional = km * 0.15
valor_total = diaria + valor_adicional
print(f'voce andou {km}km por {dias_alugados} dias, entao o preco a pagar e R${valor_total}.')
